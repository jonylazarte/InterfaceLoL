...
/*    const [battleVisible, setBattleVisible] = useState(false)*/
    ...
    useEffect(()=>{
      ...
      useEffect(()=>{
        actualSection === 'Home' && router.push('leagueoflegends')
        actualSection === 'Tienda' && router.push('store')
        actualSection === 'Colección' && router.push('collection')
        actualSection === 'ModeSelection' && router.push('room')
      },[actualSection])
  
    useEffect(()=>{
      dispatch(getUserPokemon(localStoreToken))
